    ...
    <footer className="bg-dark-gray text-fresh-white relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-16 lg:py-24">
        <div className="grid lg:grid-cols-4 gap-12 lg:gap-16">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-lg lg:text-xl font-serif font-medium text-fresh-white mb-6 lg:mb-8">Hurtige Links</h3>
            <div className="space-y-4">
              {[
                ...
                <Link
                  key={item.name}
                  to={item.path}
                  className="block text-fresh-white/80 hover:text-energetic-blue transition-all duration-300 font-light"
                >
                  {item.name}
                </Link>
              ))}
          ...
          {/* Contact Info */}
          <div>
            <h3 className="text-lg lg:text-xl font-serif font-medium text-fresh-white mb-6 lg:mb-8">Kontakt Sophie</h3>
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="text-fresh-white/90 font-light">kontakt@sophiewagner.dk</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="text-fresh-white/90 font-light">+45 23 45 67 89</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="text-fresh-white/90 font-light">København & online</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="border-t border-energetic-blue/20 mt-16 pt-8">
          <div className="text-center">
            <div className="text-fresh-white/60 text-sm font-light">
              <a href="https://panthure.dk" target="_blank" rel="noopener noreferrer" className="hover:text-energetic-blue transition-colors duration-300">
